...
describe("Location Routes", () => {
  ...
  //   const jsrLocations = await fetchLocations("", JSR_DB);
  //   const jsrfLocations = await fetchLocations("", JSRF_DB);
  ...
  //   const locations = await fetchLocations(req, "JSR");
  //   expect(Array.isArray(locations)).toBe(true);
  //   expect(isValidJson(locations)).toBe(true);
  ...
  //   const locations = await fetchLocations(req, "JSRF");
  //   expect(Array.isArray(locations)).toBe(true);
  //   expect(isValidJson(locations)).toBe(true);
...
/* Helpers */
const createJsrLocation = (testId) => {
  return {
    _id: testId,
    levels: [],
    subLocations: [
...
const createJsrfLocation = (testId) => {
  return {
    _id: testId,
    unlockableCharacters: [
      {
